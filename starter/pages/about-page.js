			...
			<div className="col-span-3">
				...
				<div className="space-y-8">
					...
					<p>
						...
						forests, breathe in the fresh air, and watch the stars twinkle above from
			...
			<div className="col-span-3">
				...
				<div className="space-y-8">
					<p>
						...
						Started by our grandparents, this haven has been nurtured with love and
						care, passing down through our family as a testament to our dedication to
					...
					<p>
						...
						soon, where tradition meets tranquility, and every visit is like coming
						home.
					</p>
